...
class CLCustomerPoint extends SC_Plugin_Base {
    ...
    function install($arrPlugin) {
        ...
        if(!isset($constants["CL_CUSTOMER_POINT_SERVER"])){
	        $masterData->insertMasterData('mtb_constants', "CL_CUSTOMER_POINT_SERVER", "\"point.dev.clay-system.jp\"", "連携するポイントシステムのホスト名");
        }
        if(!isset($constants["CL_CUSTOMER_POINT_HOST"])){
	        $masterData->insertMasterData('mtb_constants', "CL_CUSTOMER_POINT_HOST", "\"point.dev.clay-system.jp\"", "連携するポイントシステムのホスト名");
        }
